...
const sportEndpoints = {
  football: 'http://127.0.0.1:8000/MartonApp/live-matches/football',
  hockey: 'http://127.0.0.1:8000/MartonApp/live-matches/hockey',
  baseball: 'http://127.0.0.1:8000/MartonApp/live-matches/baseball',
  soccer: 'http://127.0.0.1:8000/MartonApp/live-matches/soccer'
};
const LiveArbitrage = ({ selectedSport, onSelect }) => {
  const [livematches, setLiveMatch] = useState([]);
  ...
  console.log(selectedSport);
    ...
    useEffect(() => {
      async function getAllLivematches(page, size, selectedSport){
        try{
        ...
        const response = await axios.get(`http://127.0.0.1:8000/MartonApp/live-matches/?page=${page}&page_size=${size}`);
      ...
      getAllLivematches(currentPage, pageSize, selectedSport);
