...
const PreMatch = ({ selectedSport }) => {
  const [prematches, setPreMatch] = useState([]);
  const [currentPage, setCurrentPage] = useState(1); // Track current page
  const [totalPages, setTotalPages] = useState(1);  // Track total MartonApp/pre-matches/football
  ...
  return (
    ...
    <Sidebar onSelect={(selectedSport) => handleSportSelection(selectedSport)}/>
