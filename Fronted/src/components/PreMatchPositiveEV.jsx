...
const sportEndpoints = {
  football: 'http://127.0.0.1:8000/MartonApp/pre-matches-ev/football',
  hockey: 'http://127.0.0.1:8000/MartonApp/pre-matches-ev/hockey',
  baseball: 'http://127.0.0.1:8000/MartonApp/pre-matches-ev/baseball',
  soccer: 'http://127.0.0.1:8000/MartonApp/pre-matches-ev/soccer'
};
const PreMatchPositiveEV= ({ selectedSport, onSelect }) => {
  const [prematchesev, setPreMatchEV] = useState([]);
  ...
  const [selectedOption, setSelectedOption] = useState('');
    ...
    useEffect(() => {
      async function getAllPrematchesEV(page, size, selectedSport){
        try{
        ...
        const response = await axios.get(`http://127.0.0.1:8000/MartonApp/pre-matches-ev/?page=${page}&page_size=${size}`);
        const prematchesev = response.data.results;
        console.log(prematchesev)
        setPreMatchEV(prematchesev);
      ...
      getAllPrematchesEV(currentPage, pageSize, selectedSport);
